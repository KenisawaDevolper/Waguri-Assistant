...
async function messageHandler(msg, sock, options = {}) {
  ...
  try {
    ...
    if (suggestions.length > 0) {
      ...
      const simpleMessage = `Lo siento, pero no tengo ese comando :(\n\n¿Quisiste decir este comando?\n⇒ *${suggestedCommand}*`;
      ...
      try {
        ...
        console.error("[Similitud] Error al enviar el mensaje de sugerencia:", err.message);
      }
    }
    ...
    if (isBlocked) {
      ...
      await m.reply(
        ...
        `> El bot se encuentra actualmente en el modo *${currentConfig.name}*\n` +
        `> El comando \`${m.prefix}${m.command}\` está disponible en el modo *${suggestedModeName}*\n\n` +
        `💡 Contacta al administrador del grupo para cambiar el modo:\n` +
    ...
    if (pluginCat === "rpg" && grpData.rpg === false) {
      await m.reply(
        `⚔️ *FUNCIÓN RPG DESACTIVADA*\n\nLa función RPG ha sido desactivada en este grupo por un administrador.\nPídele a un administrador que la vuelva a activar con el comando *${m.prefix}rpg on*`
      );
      return;
    }
...
const rankActions = {
    promote: {
      ...
      label: "𝗉𝗋𝗈𝗆𝗈ƚᧉ",
      text: (p, a) =>
        `ꕥ 🌿 ¡ @${p} 𝗃𝗈𝗋⍺ ᧉ𝗌 u𝗇 n̶u̶ᧉv𝗈 ⍺d𝗆ı𝗇ısƚ𝗋⍺d𝗈𝗋 ! 💕 (*ᴗ͈ˬᴗ͈)ꕤ\n` +
        `> 𝖯𝗋𝗈𝗆𝗈𝗏ıᑯ𝗈 𝗉𝗈𝗋 : @${a}`,
    },
    demote: {
      ...
      label: "ᑯᧉ𝗆𝗈ƚᧉ",
      text: (p, a) =>
        `ꕥ 🌿 @${p} y⍺ 𝗇𝗈 ᧉ𝗌 ⍺d𝗆ı𝗇ısƚ𝗋⍺d𝗈𝗋 🌧️ (*ᴗ͈ˬᴗ͈)ꕤ\n` +
        `> 𝖣ᧉ𝗀𝗋⍺ᑯ⍺ᑯ𝗈 𝗉𝗈𝗋 : @${a}`,
    },
  };
      ...
      if (rankCfg && groupData[rankCfg.notifKey] === true) {
        ...
        if (groupHandler[rankCfg.imgKey]) {
          ...
          const aNum = author?.split("@")[0] || "Desconocido";
          ...
          const fakeQuoted = {
            ...
            message: {
              conversation: action === "promote"
                ? `¡Hola a todos, ahora soy administrador aquí! (*ᴗ͈ˬᴗ͈)ꕤ`
                : `Vaya, ya no soy administrador... 🌧️ (╥﹏╥)`
            }
          };
          ...
          const promoteButtons = [
            {
              ...
              buttonParamsJson: JSON.stringify({
                display_text: "🍙 Cómo ser un buen administrador",
          ...
          const demoteButtons = [
            {
              name: "quick_reply",
              buttonParamsJson: JSON.stringify({
                display_text: "¡Mucho ánimo y fuerza! 💪",
                id: ""
              })
            }
          ];
            ...
            viewOnceMessage: {
              message: {
                ...
                interactiveMessage: {
                  ...
                  footer: { text: config.bot?.name || "Waguri AI" },
                  ...
                  contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                      ...
                      newsletterName: config.saluran?.name || config.bot?.name || "Waguri AI",
                      serverMessageId: 127,
                    },
                  },
                  nativeFlowMessage: {
                    messageParamsJson: JSON.stringify({
                      limited_time_offer: {
                        text: action === "promote" ? `✨ ¡Muchas felicidades! 🎉` : `🌧️ ¡Sigue adelante con fuerza! 💪`,
                        url: "Hola",
    ...
    if (update.announce !== undefined) {
      if (cached.announce === undefined) {
        ...
        if (update.announce === true && groupData.notifCloseGroup === true) {
          await sock.sendText(
            groupId,
            `ꕥ ⟡ 𝖤𝗅 𝗀𝗋𝗎𝗉𝗈 *${groupName}* 𝗁⍺ sıᑯ𝗈 ɔᧉrr⍺ᑯ𝗈 𝗉𝗈𝗋 u𝗇 ⍺d𝗆ı𝗇ısƚ𝗋⍺d𝗈𝗋 (*ᴗ͈ˬᴗ͈)ꕤ`,
            null,
            zannContext,
          );
        }
        ...
        if (update.announce === false && groupData.notifOpenGroup === true) {
          await sock.sendText(
            groupId,
            `ꕥ ⟡ 𝖤𝗅 𝗀𝗋𝗎𝗉𝗈 *${groupName}* 𝗁⍺ sıᑯ𝗈 ⍺bıᧉrƚ𝗈 nuᧉ᥎⍺mᧉnƚᧉ 𝗉𝗈𝗋 u𝗇 ⍺d𝗆ı𝗇ısƚ𝗋⍺d𝗈𝗋 (*ᴗ͈ˬᴗ͈)ꕤ`,
            null,
            zannContext,
          );
        }
    ...
    if (update.restrict !== undefined) {
      if (cached.restrict === undefined) {
        ...
        if (update.restrict === true) {
          await sock.sendText(
            groupId,
            `ꕥ ⟡ 𝖨𝗇𝖿𝗈 ᑯᧉ𝗅 𝗀𝗋𝗎𝗉𝗈 *${groupName}* rᧉsƚrı𝗇gıᑯ⍺ !\n> S𝗈𝗅𝗈 los ⍺d𝗆ı𝗇ısƚ𝗋⍺dores puᧉdᧉn ᧉdıƚ⍺r ᧉl gruᧉpo (*ᴗ͈ˬᴗ͈)ꕤ`,
            null,
            zannContext,
          );
        } else {
          await sock.sendText(
            groupId,
            `ꕥ ⟡ 𝖨𝗇𝖿𝗈 ᑯᧉ𝗅 𝗀𝗋𝗎𝗉𝗈 *${groupName}* ⍺bıᧉrƚ⍺ !\n> Todos los mᧉmbros puᧉdᧉn ᧉdıƚ⍺r ᧉl gruᧉpo (*ᴗ͈ˬᴗ͈)ꕤ`,
            null,
            zannContext,
          );
        }
