import {
  ...
  getRandomReward,
  getProgressiveHint,
} from "./rimuru-game-data.js";
import { getDatabase } from "./rimuru-database.js";
import { addExpWithLevelCheck } from "./rimuru-level.js";
import {
  getGameContextInfo,
  sendGamePreview,
  checkFastAnswer,
} from "./rimuru-context.js";
import config from "../../config.js";
import fs from "fs";
import sharp from "sharp";
let fetchBuffer;
try {
  fetchBuffer = (await import("./rimuru-utils.js")).fetchBuffer;
} catch { }
...
const games = new rimuruGames();

export { rimuruGames, games };
