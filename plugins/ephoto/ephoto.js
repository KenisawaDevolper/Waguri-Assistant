...
async function handler(m, { sock }) {
    ...
    if (command === 'ephoto') {
        ...
        return m.reply(
            ...
            `> _Efectos Ephoto ≽^• ˕ • ྀི≼_\n\n` +
            `## ꕥ *W⍺gurı 𝖠ssı𝗌ƚ⍺nƚ* (*ᴗ͈ˬᴗ͈)ꕤ\n` +
            `> 𝖤𝖥𝖤𝖢𝖳𝖮𝖲 𝖣𝖤 𝖳𝖤𝖷𝖳𝖮 𝖤𝖯𝖧𝖮𝖳𝖮\n\n` +
            `> ¡Crea efectos de texto geniales!\n\n` +
            `╭┈┈⬡「 📋 *𝖫𝖨𝖲𝖳𝖠 𝖣𝖤 𝖤𝖥𝖤𝖢𝖳𝖮𝖲* 」\n${effectList}\n╰┈┈┈┈┈┈┈┈⡡\n\n` +
            `> *Ejemplo:* \`${m.prefix}glitchtext Waguri\`\n\n` +
    ...
    if (!text) {
        return m.reply(
            `*¡Hola, buenas tardes!* ฅ^·ﻌ·^ฅ\n` +
            `> _Error de entrada ≽^• ˕ • ྀི≼_\n\n` +
            `## ꕥ *W⍺gurı 𝖠ssı𝗌ƚ⍺nƚ* (*ᴗ͈ˬᴗ͈)ꕤ\n` +
            `> 𝖳𝖤𝖷𝖳𝖮 𝖥𝖠𝖫𝖳𝖠𝖭𝖳𝖤\n\n` +
            `> Error: ¡Por favor ingresa un texto!\n` +
            `> *Ejemplo:* \`${m.prefix}${command} Waguri\`\n\n` +
            `> sɪᴍᴘʟᴇ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ ツ`
        )
    }
    ...
    if (!effectUrl) {
        return m.reply(
            `*¡Hola, buenas tardes!* ฅ^·ﻌ·^ฅ\n` +
            `> _Error de efecto ≽^• ˕ • ྀི≼_\n\n` +
            `## ꕥ *W⍺gurı 𝖠ssı𝗌ƚ⍺nƚ* (*ᴗ͈ˬᴗ͈)ꕤ\n` +
            `> 𝖤𝖥𝖤𝖢𝖳𝖮 𝖭𝖮 𝖤𝖭𝖢𝖮𝖭𝖳𝖱𝖠𝖣𝖮\n\n` +
            `> Error: ¡El efecto especificado no fue encontrado!\n\n` +
            `> sɪᴍᴘʟᴇ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ ツ`
        )
    }
