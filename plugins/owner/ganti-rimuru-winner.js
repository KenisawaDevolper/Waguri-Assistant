...
async function handler(m, { sock }) {
    ...
    try {
        ...
        try {
            const newUrl = await updateAssetUrl('rimuru-winner', buffer, 'rimuru-winner.jpg')
            m.reply(`✅ *ʙᴇʀʜᴀsɪʟ*\n\n> Gambar rimuru-winner.jpg telah diganti ke URL baru:\n> ${newUrl}\n> Config telah diupdate secara realtime!`)
        } catch (e) {
