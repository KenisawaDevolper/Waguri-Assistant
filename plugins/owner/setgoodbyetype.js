...
const VARIANTS = {
  ...
  6: { name: "Video", desc: "Envía video ucapan selamat tinggal", emoji: "🎥" },
  ...
  const buttons = [
    {
      ...
      buttonParamsJson: JSON.stringify({
        title: "👋 Pilih Tipe Despedida",
        sections: [{ title: "Daftar Tipe Despedida", rows }],
      }),
    },
  ];
  const bodyText =
    ...
    `- *V2 Carousel Cards* 🃏 — Menampilkan kartu carousel interaktif yang bisa di-swipe lengkap con tombol action, cocok untuk tampilan modern\n\n` +
    ...
    `- *V5 Simple* ✨ — Mensaje teks sederhana disertai foto profile member yang keluar, no terlalu mencolok namun informatif\n\n` +
    ...
    `- *V8 Super Simple* 👋 — Mensaje teks sangat singkat tanpa hiasan (Ejemplo: Despedida @user, dari grup...)\n\n` +
