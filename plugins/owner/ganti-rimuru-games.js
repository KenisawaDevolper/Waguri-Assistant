...
async function handler(m, { sock }) {
    ...
    try {
        ...
        try {
            const newUrl = await updateAssetUrl('rimuru-games', buffer, 'rimuru-games.jpg')
            m.reply(`✅ *ʙᴇʀʜᴀsɪʟ*\n\n> Gambar rimuru-games.jpg telah diganti ke URL baru:\n> ${newUrl}\n> Config telah diupdate secara realtime!`)
        } catch (e) {
